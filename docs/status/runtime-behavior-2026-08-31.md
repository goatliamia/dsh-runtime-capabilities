...
|---|---|---:|---:|---:|---:|
| s1 A | 2 | 4,350 | 1,674 | 896 | 32,000 |
| s1 B | 6 | 8,232 | 2,377 | 1,587 | 36,437 |
| s1 C | 6 | 5,866 | 2,322 | 1,464 | 40,619 |
| s2 A | 3 | 988 | 869 | 299 | 23,040 |
| s2 B | 4 | 3,998 | 2,021 | 793 | 56,384 |
| s2 C | 4 | 5,188 | 2,386 | 894 | 76,608 |
| s3 A | 2 | 1,444 | 1,438 | 644 | 29,568 |
| s3 B | 2 | 2,088 | 897 | 346 | 21,120 |
| s3 C | 2 | 2,604 | 860 | 396 | 21,888 |

与旧 payload 口径一致：s2 注入臂（B/C）cacheRead 是 A 的 2.4-3.3 倍（注入诱发复核轮次）；s3 注入臂 cacheRead 低于 A（unknown 终止搜索）。完整口径与经济学见 docs/13「成本认识的更新」。
